...
int main (int argv, char **argc) {
	...
	int N = 10;					//Number of stars, Mcl will be set to 0 if specified!
	...
	double Rh = 1.0;				//Half-mass radius [pc], ignored if profile = 3, set =-1 for using Marks & Kroupa (2012) Mcl-Rh relation
	...
	int mfunc = 0;					//0 = single mass stars; 1 = use Kroupa (2001) mass function; 2 = use multi power law (based on mufu.c by L.Subr)
