...
LOGICAL check
  ...
  call newt(x,N,check)
  call funcv(N,x,f,x0,y0,z0,vx0,vy0,vz0,vc)
    if (check) then
...
! vx*rx+vy*ry+vz*rz=0.
    ...
    write(2,*)m_p/M_Sun,x0/(206264.806*AU),y0/(206264.806*AU),z0/(206264.806*AU),vx0/1000.,vy0/1000.,vz0/1000.
...
End program
!!!!!!!!!!
SUBROUTINE inputr(x0,y0,z0)
REAL x0,y0,z0

return
END
!*****************************************************
SUBROUTINE funcv(n,x,f,x0,y0,z0,vx0,vy0,vz0,vc)
INTEGER n
REAL x(n),f(n),x0,y0,z0,vx0,vy0,vz0,vrx,vry,vrz,v0,r0,vc
...
INTEGER i
REAL sum
call funcv(n,x,fvec,x0,y0,z0,vx0,vy0,vz0,vc)
sum=0.
do 11 i=1,n
sum=sum+fvec(i)**2
11 continue
